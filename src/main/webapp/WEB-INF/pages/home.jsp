...
<div class="pageContainer">
    ...
    <div class="line1">
        <div class="box">
            ...
            <p> К настоящему времени сформировалась целая отрасль инфокоммуникаций, связанная с передачей информации,
                которая объединяет информационные и телекоммуникационные технологии и ориентирована на расширение сетей
                связи
        ...
        <div class="box">
            ...
            <p> Факультет, опираясь на обширные связи с отечественными и зарубежными предприятиями и фирмами,
                высококлассными
                специалистами и современными научными и учебными лабораториями, постоянно совершенствует образовательный
                процесс
    ...
    <div class="line2">
        <div class="box">
            ...
            <p> Обучение на факультете сочетает фундаментальную подготовку по математике, физике, химии,
                программированию с углубленным изучением основ современной радиотехники
        ...
        <div class="box">
            ...
            <p> Инженерно-экономический факультет готовит специалистов, обладающих интегрированными знаниями в области
                экономики и современных информационных технологий,
    ...
    <div class="line3">
        <div class="box">
            ...
            <p> На сегодняшний день на факультете обучаются около 2000 студентов по четырем специальностям -
                «Вычислительные машины,
                системы и сети», «Информатика и технологии программирования», «Программное обеспечение информационных
                технологий»,«Электронные вычислительные средства».
